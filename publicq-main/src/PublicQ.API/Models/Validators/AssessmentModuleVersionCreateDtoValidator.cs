...
/// <summary>
/// Validator for AssessmentModuleVersionCreateDto <seealso cref="AssessmentModuleVersionCreateDto"/>
/// </summary>
public class AssessmentModuleVersionCreateDtoValidator : AbstractValidator<AssessmentModuleVersionCreateDto>
{
    /// <summary>
    /// Default constructor
    /// </summary>
    public AssessmentModuleVersionCreateDtoValidator()
    {
        RuleFor(x => x.Title)
            .NotEmpty()
