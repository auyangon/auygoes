  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        {/* Header with student info prominently displayed */}
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-4xl font-bold text-white mb-1 flex items-center gap-2">
                {greeting.text}, {studentName || user?.displayName || 'Student'}
        ...
        {/* Student Stats Cards - All data guaranteed to show */}
        ...
        {/* Current Courses - Shows real enrolled courses */}
        <section>
